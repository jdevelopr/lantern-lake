...
const ZONE_IN = { shallows: 'the shallows', reeds: 'the reeds', open: 'open water', deep: 'the deep water' };
...
export function firstText(first) {
  ...
  return `${SEASON_NAMES[seasonOf(first.day)]} day ${dayOfSeason(first.day)}, ${ZONE_IN[first.zone] || first.zone}, ${w}`;
}
